...
const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { title: 'Library', icon: Library, path: '/library', roles: ['SUPER_ADMIN', 'COLLEGE_ADMIN', 'PRINCIPAL', 'FACULTY', 'STUDENT', 'LIBRARIAN', 'STAFF'] },
  { title: 'Attendance', icon: ClipboardList, path: '/attendance', roles: ['SUPER_ADMIN', 'COLLEGE_ADMIN', 'PRINCIPAL', 'FACULTY', 'STUDENT', 'PARENT'] },
  { title: 'Exams', icon: FileText, path: '/exams', roles: ['SUPER_ADMIN', 'COLLEGE_ADMIN', 'PRINCIPAL', 'FACULTY', 'STUDENT', 'PARENT'] },
  { title: 'Results', icon: Award, path: '/results', roles: ['SUPER_ADMIN', 'COLLEGE_ADMIN', 'PRINCIPAL', 'FACULTY', 'STUDENT', 'PARENT'] },
